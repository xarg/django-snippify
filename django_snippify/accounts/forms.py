...
class EditForm(forms.Form):
    ...
    user_follows_you = forms.BooleanField(required = False,
        label="Users follows me", help_text="Notify me when someone starts following me")
    followed_user_created = forms.BooleanField(required = False,
        label="Followed user submited snippet",
        help_text="Notify me when someone that I follow submits a snippet")
    user_commented = forms.BooleanField(required = False,
        label='Snippet commented', help_text="Notify me when I recieve a comment")
    #TODO
    #user_shared = forms.BooleanField(required = False,
    #    label="User shared", help_text='Notify me if a user shared with me a snippet')
    ...
    snippet_privacy = forms.ChoiceField(choices = PRIVACY_CHOICES,
        help_text = "This is the default privacy setting when you add new snippets")
